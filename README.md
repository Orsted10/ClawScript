...
The goal is not to clone an existing language, but to **understand how real programming languages are built internally** — step by step — while keeping the design clean, readable, and extendable.
